...
## Key Stakeholders
The key stakeholders affected by this decision include the Ilitch ownership group, who demand a return on their significant payroll investment; the coaching staff led by Todd McLellan, whose defensive-minded system may conflict with an analytics-based push for high-risk offence; and a fanbase that has not witnessed a playoff game in ten years. Additionally, the players themselves, specifically core young stars like Moritz Seider and Lucas Raymond, are stakeholders, as their prime career years rely on management surrounding them with a competitive roster.

## Historical Context and Current Approach
What has been tried before is a conservative “best player available” strategy in the draft, combined with signing mid-tier unrestricted free agents (such as J.T. Compher and Andrew Copp) to fill roster gaps. This approach raised the team's floor but failed to raise its ceiling, resulting in consecutive seasons finishing just outside the playoff picture. The current approach relies on internal growth and hopes that young prospects outperform their contracts. However, statistical models suggest that internal growth alone is insufficient to bridge the gap from a 90-point team to a 100-point contender. A deliberate, data-backed allocation of the remaining cap space is required to purposefully tip the scales.
